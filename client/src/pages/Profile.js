...
function Profile() {
  return (
    <div class="container pt-5">
      ...
      <div className="modal" id="delete-user-modal" tabindex="-1" role="dialog">
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Re-Enter Credentials to delete user</h5>
                ...
                <form>
                  <div className="form-group">
                    <label for="userEmail">Email:</label>
                      <input type="text" className="form-control" id="userEmail"></input>
                  </div>
                  <div className="form-group">
            ...
            <div className="modal-footer">
              <button id="confirm-delete" type="button" data-id="{{userInfo.id}}" className="btn btn-primary">Confirm Delete</button>
              <button type="button" className="btn btn-secondary" data-dismiss="modal">Nah I'll stay</button>
            </div>
